...
public class Jackson2ObjectMapperBuilder {
	...
	public Jackson2ObjectMapperBuilder locale(String localeString) {
		this.locale = org.springframework.util.StringUtils.parseLocaleString(localeString);
		return this;
	}
	...
	public Jackson2ObjectMapperBuilder timeZone(String timeZoneString) {
		this.timeZone = org.springframework.util.StringUtils.parseTimeZoneString(timeZoneString);
		return this;
	}
