package com.tamboot.http.httpclient;

import com.tamboot.common.tools.base.ExceptionUtil;
import com.tamboot.http.config.TambootHttpProperties;
...
public class PoolingHttpClient {
    ...
    private TambootHttpProperties.HttpClient config;

    private CloseableHttpClient client;

    public PoolingHttpClient(TambootHttpProperties properties) {
        Assert.notNull(properties, "[tamboot.http] must not be null");
        Assert.notNull(properties.getHttpclient(), "[tamboot.http.httpclient] must not be null");
