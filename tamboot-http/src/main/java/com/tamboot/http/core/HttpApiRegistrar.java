...
import com.tamboot.http.config.TambootHttpAutoConfiguration;
...
public class HttpApiRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        AnnotationTypeFilter annotationTypeFilter = new AnnotationTypeFilter(HttpApi.class);
    ...
    private void doScan(BeanDefinitionRegistry registry, String basePackage, ClassPathScanningCandidateComponentProvider scanner) {
        ...
        for (BeanDefinition candidateComponent : candidateComponents) {
            ...
            Assert.isTrue(annotationMetadata.isInterface(), "@HttpApi can only be specified on an interface");

            Map<String, Object> attributes = annotationMetadata.getAnnotationAttributes(HttpApi.class.getCanonicalName());
            ...
            registerHttpApi(registry, beanName, beanUnderlyingClass, attributes);
        }
    }

    private void registerHttpApi(BeanDefinitionRegistry registry, String beanName, Class<?> beanUnderlyingClass, Map<String, Object> attributes){
        BeanDefinitionBuilder bdBuilder = BeanDefinitionBuilder.genericBeanDefinition(HttpApiFactoryBean.class);
        ...
        bdBuilder.addPropertyReference("client", TambootHttpAutoConfiguration.DEFAULT_FEIGN_CLIENT_BEAN_NAME);
    ...
    private Set<String> resolveBasePackages() {
        ...
        String pkg = this.environment.getProperty("tamboot.http.basePackage");
